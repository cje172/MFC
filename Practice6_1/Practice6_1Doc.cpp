...
// 축소판 그림을 지원합니다.
void CPractice5_1Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CPractice5_1Doc::InitializeSearchContent()
{
...
void CPractice5_1Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
